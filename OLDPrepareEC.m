...
HYMASTERDR=permute(HYMASTERDR,[3,2,1]);   %permute command is used to change the dimensions of a matrix... Read more on http://stackoverflow.com/questions/21100168/how-does-the-permute-function-in-matlab-work

% Define an empty smaller matrix to store draws from the Master Draws
HYDR=zeros((NALTMAX-1),NP,NDRAWS);
